...
Feature roadmap for Timely, organized by phase. Each phase builds on the previous one.
...
Making Timely the go-to tool for scheduling across timezones.
...
- [ ] **Calendar event creation** -- Create events directly from Timely with automatic timezone conversion for attendees in different zones.
...
Taking Timely beyond a single Mac.
